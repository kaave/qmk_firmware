...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LALT,  KC_LGUI, KC_LALT, KC_FN1, KC_LGUI,
                                                      KC_BSPC, KC_DELT,
                                                               KC_HOME,
                                              KC_SPC, KC_ENT, KC_END,

        // right hand
        KC_PLUS,  KC_6,   KC_7,     KC_8,    KC_9,    KC_0,    KC_BSPC,
 ...
 * |        | F11  | F12  |      |      |      |      |           |      |      |      |      |  [{  |  }]  |        |
 * |--------+------+------+------+------+------|  (   |           |   )  |------+------+------+------+------+--------|
 * |        |VolDp |VolUn | Mute |      |      |------|           |------| LEFT |  UP  | DOWN |RIGHT |  '"  |   +=   |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |      |      |      |      |      |           |      |      |      |      |      |  ~`  |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      |      |      |                                       |      |      |      |      |      |
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS, KC_F11,  KC_F12,  KC_TRNS, KC_TRNS, KC_TRNS, KC_LPRN,
       ...
       KC_RPRN, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
